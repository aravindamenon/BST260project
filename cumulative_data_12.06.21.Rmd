...
>>>>>>> 9cecb2cd1261e82a90e82b1a6fea799b721ea101
```
...
# Removed the last two lines as no longer using AQI and ADI
```
...
tree_fit <- train_set %>% 
 rpart(avg_sale_price ~ av_bldg + av_land + av_total + gross_tax + land_sf + living_area + bedrooms.y + bath_full + yr_remod + neighborhood, data = ., maxdepth = 5, minbucket = 1)

tree_fit
rpart.plot(tree_fit, type = 3, digits = 3, fallen.leaves = T, tweak = 0.35)
...
tree_fit_2
rpart.plot(tree_fit_2, type = 3, digits = 3, fallen.leaves = T, tweak = 0.35)
