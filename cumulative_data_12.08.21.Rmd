...
eval_all2<-eval_all%>% mutate(prsqft=av_total/(land_sf+living_area))%>%filter(neighborhood!="Boston")%>% group_by(year,neighborhood)%>%summarise(avgprsqft=mean(prsqft,na.rm=T))  
